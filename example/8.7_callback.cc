...
int main(int argc, char ** argv)
{
  ...
  std::generate(c->begin(), c->end(), std::bind(unif_distr, generator)); // 绑定unif_distr、generator生成新的函数对象
  ...
  if ( slvr == "psim")
    ...
    M->setSolverParam("optimizer", "intpnt"); // 默认内点法
